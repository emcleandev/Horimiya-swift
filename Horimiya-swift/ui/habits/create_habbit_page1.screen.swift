//
//  create_habbit.page1.screen.swift
//  Horimiya-swift
//
...
struct CreateHabitPage1: View {
    @State var titleBook = ""
    @State var author = ""
    @State var isExchange: Bool = true
    @State var description = "A Good habbit motivated by..."
    @State var price = ""
    ...
    var body: some View {
        Form {
            ...
            Section(header: Text("Basic info").padding(.top, 10)) {
                TextField("Habbit Title", text: $titleBook)
            }
...
struct create_habbit_page1_screen_Previews: PreviewProvider {
